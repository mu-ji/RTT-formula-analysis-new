...
every_distance_sample_number = 20
...
def sample_data(input_file, output_file, one_sample_length):
    ...
    n = np.random.randint(len(lines)/2,len(lines)-one_sample_length)
    rtt_list = []
    rssi_list = []
...
output_file = 'test_set/indoor_without_people_walking_train_set1000.txt'
